  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <MoneyCard title="Receita bruta" value={receitas} icon={DollarSign} trend={{ value: 12, label: 'vs anterior' }} />
        <MoneyCard title="Despesas" value={despesas} icon={ArrowDownRight} />
        <MoneyCard title="Lucro líquido" value={liquido} icon={TrendingUp} trend={{ value: 8, label: 'vs anterior' }} />
        <MoneyCard title="Comissões" value={comissoes} icon={Users} />
      </div>
